...
doc_review_notes:
  ...
  glossary.md#value_encoded_decision: Reviewed glossary.md#value_encoded_decision
    rev1 (value-encoded decision surface semantics).
  ...
  CONTRIBUTING.md#contributing_contract: Reviewed CONTRIBUTING.md rev1 (docflow now
    ...
    document's scope.
  AGENTS.md#agent_obligations: Agent obligations unchanged; value-encoded decision
    semantics align with glossary tiers.
...
doc_section_reviews:
  in_in_18:
    ...
    glossary.md#value_encoded_decision:
      ...
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#value_encoded_decision rev1 (value-encoded decision
        surface semantics).
    glossary.md#tier:
      dep_version: 1
      self_version_at_review: 1
    ...
    AGENTS.md#agent_obligations:
      ...
      self_version_at_review: 1
      outcome: no_change
      note: Agent obligations unchanged; value-encoded decision semantics align with
        glossary tiers.
---
