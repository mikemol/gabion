...
doc_review_notes:
  ...
  glossary.md: "Reviewed glossary update (Evidence Key / dominance); evidence-first semantics align."
...
- **Schema (current):**
  ...
  - `suggestions: [ { "test_id": str, "file": str, "line": int, "suggested": [ { "key": { ...EvidenceKey... }, "display": str } ], "matched": [str], "source": "graph"|"heuristic" } ]`
