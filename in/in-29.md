...
doc_review_notes:
  ...
  glossary.md#contract: Reviewed glossary.md#contract rev1 (glossary contract + semantic
    typing discipline).
  glossary.md#evidence_id: Reviewed glossary.md#evidence_id rev1 (evidence ID stability
    + canonical Evidence Key).
  glossary.md#witness: Reviewed glossary.md#witness rev1 (tests as witnesses to evidence
    IDs).
  glossary.md#evidence_surface: Reviewed glossary.md#evidence_surface rev1 (evidence
    surface as set of IDs).
  glossary.md#evidence_dominance: Reviewed glossary.md#evidence_dominance rev1 (strict
    dominance ordering by evidence sets).
  glossary.md#equivalent_witness: Reviewed glossary.md#equivalent_witness rev1 (equivalent
    witness classes remain non-redundant).
  glossary.md#test_obsolescence_projection: Reviewed glossary.md#test_obsolescence_projection
    rev1 (obsolescence projection determinism + guardrails).
  glossary.md#test_evidence_suggestions_projection: Reviewed glossary.md#test_evidence_suggestions_projection
    rev1 (graph-first suggestion semantics).
  glossary.md#evidence_key: Reviewed glossary.md#evidence_key rev1 (graph-derived
    evidence identity; display non-canonical).
  ...
  AGENTS.md#agent_obligations: Agent obligations unchanged; evidence mapping aligns
    with review discipline.
  in/in-23.md#in_in_23: Reviewed in/in-23.md rev7 (HOL proof + embedded logical systems
    list + normalization-as-evaluation); no conflicts.
  in/in-24.md#in_in_24: Reviewed in/in-24.md rev8 (deadness witness pinning); no conflicts.
  in/in-25.md#in_in_25: Reviewed in/in-25.md rev8 (deadness witness pinning); coherence
    evidence unaffected.
  in/in-26.md#in_in_26: Reviewed in/in-26.md rev8 (updated pins to in-23/24/25); refactor
    obligations consume evidence artifacts.
  in/in-27.md#in_in_27: Reviewed in/in-27.md rev6 (coherence witness pinning); exception-safety
...
doc_section_reviews:
  in_in_29:
    ...
    glossary.md#evidence_id:
      ...
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#evidence_id rev1 (evidence ID stability + canonical
        Evidence Key).
    glossary.md#witness:
      dep_version: 1
      self_version_at_review: 1
    ...
    glossary.md#evidence_surface:
      ...
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#evidence_surface rev1 (evidence surface as set of
        IDs).
    glossary.md#evidence_dominance:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#evidence_dominance rev1 (strict dominance ordering
        by evidence sets).
    glossary.md#equivalent_witness:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#equivalent_witness rev1 (equivalent witness classes
        remain non-redundant).
    glossary.md#test_obsolescence_projection:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#test_obsolescence_projection rev1 (obsolescence projection
        determinism + guardrails).
    glossary.md#test_evidence_suggestions_projection:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#test_evidence_suggestions_projection rev1 (graph-first
        suggestion semantics).
    glossary.md#evidence_key:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#evidence_key rev1 (graph-derived evidence identity;
        display non-canonical).
    CONTRIBUTING.md#contributing_contract:
      dep_version: 2
      self_version_at_review: 1
      outcome: no_change
    ...
    in/in-23.md#in_in_23:
      ...
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed in/in-23.md rev7 (HOL proof + embedded logical systems list +
        normalization-as-evaluation); no conflicts.
    in/in-24.md#in_in_24:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
    ...
    in/in-25.md#in_in_25:
      ...
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed in/in-25.md rev8 (deadness witness pinning); coherence evidence
        unaffected.
    in/in-26.md#in_in_26:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed in/in-26.md rev8 (updated pins to in-23/24/25); refactor obligations
        consume evidence artifacts.
    in/in-27.md#in_in_27:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed in/in-27.md rev6 (coherence witness pinning); exception-safety
        obligations unaffected.
    in/in-28.md#in_in_28:
      dep_version: 1
      self_version_at_review: 1
