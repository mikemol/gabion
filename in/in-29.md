...
doc_review_notes:
  ...
  glossary.md: "Reviewed glossary rev29 (obsolescence projection path + self-review/mirror definitions); evidence-first semantics align."
  ...
  AGENTS.md: "Agent obligations unchanged; evidence mapping aligns with review discipline."
...
Normative pointers (explicit): `POLICY_SEED.md`, `glossary.md`, `CONTRIBUTING.md`, `README.md`, `AGENTS.md`, `in/in-23.md`, `in/in-24.md`, `in/in-25.md`, `in/in-26.md`, `in/in-27.md`, `in/in-28.md`.
