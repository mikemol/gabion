...
doc_requires:
  ...
  - glossary.md#evidence_id
  - glossary.md#witness
  - glossary.md#evidence_surface
  - glossary.md#evidence_dominance
  - glossary.md#equivalent_witness
  - glossary.md#test_obsolescence_projection
  - glossary.md#test_evidence_suggestions_projection
  - glossary.md#evidence_key
...
doc_reviewed_as_of:
  ...
  glossary.md#evidence_id: 1
  glossary.md#witness: 1
  glossary.md#evidence_surface: 1
  glossary.md#evidence_dominance: 1
  glossary.md#equivalent_witness: 1
  glossary.md#test_obsolescence_projection: 1
  glossary.md#test_evidence_suggestions_projection: 1
  glossary.md#evidence_key: 1
...
doc_review_notes:
  ...
  glossary.md#evidence_id: Reviewed glossary.md#evidence_id rev1 (evidence ID stability + canonical Evidence Key).
  glossary.md#witness: Reviewed glossary.md#witness rev1 (tests as witnesses to evidence IDs).
  glossary.md#evidence_surface: Reviewed glossary.md#evidence_surface rev1 (evidence surface as set of IDs).
  glossary.md#evidence_dominance: Reviewed glossary.md#evidence_dominance rev1 (strict dominance ordering by evidence sets).
  glossary.md#equivalent_witness: Reviewed glossary.md#equivalent_witness rev1 (equivalent witness classes remain non-redundant).
  glossary.md#test_obsolescence_projection: Reviewed glossary.md#test_obsolescence_projection rev1 (obsolescence projection determinism + guardrails).
  glossary.md#test_evidence_suggestions_projection: Reviewed glossary.md#test_evidence_suggestions_projection rev1 (graph-first suggestion semantics).
  glossary.md#evidence_key: Reviewed glossary.md#evidence_key rev1 (graph-derived evidence identity; display non-canonical).
  ...
  AGENTS.md#agent_obligations: Agent obligations unchanged; evidence mapping aligns with review discipline.
  ...
  in/in-24.md#in_in_24: Reviewed in/in-24.md rev8 (deadness witness pinning); no conflicts.
  in/in-25.md#in_in_25: Reviewed in/in-25.md rev8 (deadness witness pinning); coherence evidence unaffected.
  in/in-26.md#in_in_26: Reviewed in/in-26.md rev8 (updated pins to in-23/24/25); refactor obligations consume evidence artifacts.
  in/in-27.md#in_in_27: Reviewed in/in-27.md rev6 (coherence witness pinning); exception-safety obligations unaffected.
...
doc_section_reviews:
  in_in_29:
    ...
    glossary.md#evidence_id:
      ...
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#evidence_id rev1 (evidence ID stability + canonical Evidence Key).
    glossary.md#witness:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#witness rev1 (tests as witnesses to evidence IDs).
    glossary.md#evidence_surface:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#evidence_surface rev1 (evidence surface as set of IDs).
    glossary.md#evidence_dominance:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#evidence_dominance rev1 (strict dominance ordering by evidence sets).
    glossary.md#equivalent_witness:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#equivalent_witness rev1 (equivalent witness classes remain non-redundant).
    glossary.md#test_obsolescence_projection:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#test_obsolescence_projection rev1 (obsolescence projection determinism + guardrails).
    glossary.md#test_evidence_suggestions_projection:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#test_evidence_suggestions_projection rev1 (graph-first suggestion semantics).
    glossary.md#evidence_key:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#evidence_key rev1 (graph-derived evidence identity; display non-canonical).
    CONTRIBUTING.md#contributing_contract:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
    ...
    AGENTS.md#agent_obligations:
      ...
      self_version_at_review: 1
      outcome: no_change
      note: Agent obligations unchanged; evidence mapping aligns with review discipline.
    in/in-23.md#in_in_23:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
    ...
    in/in-24.md#in_in_24:
      ...
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed in/in-24.md rev8 (deadness witness pinning); no conflicts.
    in/in-25.md#in_in_25:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed in/in-25.md rev8 (deadness witness pinning); coherence evidence unaffected.
    in/in-26.md#in_in_26:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed in/in-26.md rev8 (updated pins to in-23/24/25); refactor obligations consume evidence artifacts.
    in/in-27.md#in_in_27:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed in/in-27.md rev6 (coherence witness pinning); exception-safety obligations unaffected.
    in/in-28.md#in_in_28:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
...
Normative pointers (explicit): [POLICY_SEED.md#policy_seed](POLICY_SEED.md#policy_seed), [glossary.md#contract](glossary.md#contract), [glossary.md#evidence_id](glossary.md#evidence_id), [glossary.md#witness](glossary.md#witness), [glossary.md#evidence_surface](glossary.md#evidence_surface), [glossary.md#evidence_dominance](glossary.md#evidence_dominance), [glossary.md#equivalent_witness](glossary.md#equivalent_witness), [glossary.md#test_obsolescence_projection](glossary.md#test_obsolescence_projection), [glossary.md#test_evidence_suggestions_projection](glossary.md#test_evidence_suggestions_projection), [glossary.md#evidence_key](glossary.md#evidence_key), [CONTRIBUTING.md#contributing_contract](CONTRIBUTING.md#contributing_contract), [README.md#repo_contract](README.md#repo_contract), [AGENTS.md#agent_obligations](AGENTS.md#agent_obligations), [in/in-23.md#in_in_23](in/in-23.md#in_in_23), [in/in-24.md#in_in_24](in/in-24.md#in_in_24), [in/in-25.md#in_in_25](in/in-25.md#in_in_25), [in/in-26.md#in_in_26](in/in-26.md#in_in_26), [in/in-27.md#in_in_27](in/in-27.md#in_in_27), [in/in-28.md#in_in_28](in/in-28.md#in_in_28).
...
- **F2 (Evidence-first obsolescence):** “Obsolete candidate” classification shall be computed primarily from **evidence dominance**, not line/branch novelty.
  - **Witness hook:** `artifacts/out/test_obsolescence_report.json` with dominance reasons.
...
- **Normative evidence posture:** Evidence/witness vocabulary and ratchet philosophy from `POLICY_SEED.md#policy_seed` and the `in-23`–`in-27` series.
...
3. **Compute evidence-first dominance and obsolescence candidates**
   ...
   - Produce `artifacts/out/test_obsolescence_report.json` + markdown summary.
...
4. **Emit projections via the canonical front door**
   ...
   - JSON projections are written under `artifacts/out/`; Markdown companions stay under `out/`.
...
### Determinism key disclosure rule (normative)

Any enforced ordering in this contract must name its comparator semantics.

* **Lexical ordering:** compare canonical string fields directly (for example,
  `test_id`, `class`, `evidence_id`).
* **EvidenceKey identity ordering:** compare
  `gabion.analysis.evidence_keys.key_identity(key)`, where `key_identity`
  normalizes the EvidenceKey and serializes canonical JSON (`sort_keys=True`,
  compact separators) as the identity string.
* **Non-lexical ordering:** when a comparator is tuple-structured or otherwise
  non-lexical, the tuple components and rationale must be declared in the
  producer/helper contract.

### Required artifacts

#### `out/test_evidence.json`
- **Producer:** `scripts/misc/extract_test_evidence.py`
...
- **Determinism:** tests sorted by lexical `test_id`; evidence entries sorted by
  EvidenceKey identity (`key_identity`); `evidence_index` sorted by
  EvidenceKey identity (`key_identity`).
...
- **Determinism:** sorted by lexical `test_id`; evidence entries sorted by
  EvidenceKey identity (`key_identity`).
...
- **Determinism:** stable lexical ordering by `evidence_id`
...
- **Schema (current):**
  - `version: 3`
  - `generated_by_spec_id: str` (hash‑consed canonical ProjectionSpec; not a digest)
  - `generated_by_spec: { ...normalized ProjectionSpec... }` (must canonicalize to `generated_by_spec_id`)
...
- **Determinism:** stable lexical ordering by `class`, then lexical `test_id`.
...
- **Schema (current):**
  ...
  - `generated_by_spec_id`, `generated_by_spec` (same hash‑consed canonical semantics)
- **Determinism:** tests sorted by lexical `test_id`; evidence entries sorted by
  EvidenceKey identity (`key_identity`).
...
- **Schema (current):**
  ...
  - `generated_by_spec_id`, `generated_by_spec` (canonicalized, not digests)
- **Determinism:** lists sorted by lexical `test_id` and EvidenceKey identity
  (`key_identity`).
...
#### `artifacts/out/test_branch_coverage.json`
...
#### `artifacts/out/test_line_coverage.json`
- **Producer:** coverage collector (future)
- **Consumer:** behavioral tie-breakers (future)
...
This document conforms to the canonical `in_step` template defined in `in/in-28.md#in_in_28`.
