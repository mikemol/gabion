...
doc_review_notes:
  ...
  glossary.md#deadness_witness: Reviewed glossary.md#deadness_witness rev1 (deadness witness requirements for exception discharge).
  glossary.md#coherence_witness: Reviewed glossary.md#coherence_witness rev1 (coherence witness requirements for branching exception paths).
  glossary.md#exception_path: Reviewed glossary.md#exception_path rev1 (exception path enumeration + stability).
  ...
  AGENTS.md#agent_obligations: Agent obligations unchanged; exception obligations remain audit-driven.
  in/in-23.md#in_in_23: Reviewed in/in-23.md rev7 (deadness witness pinning added); no conflicts.
  in/in-24.md#in_in_24: Reviewed in/in-24.md rev8 (deadness witnesses discharge exception obligations).
  in/in-25.md#in_in_25: Reviewed in/in-25.md rev8 (coherence evidence remains orthogonal to exception obligations).
  in/in-26.md#in_in_26: Reviewed in/in-26.md rev8 (rewrite verification predicates include exception obligations).
...
doc_section_reviews:
  in_in_27:
    ...
    glossary.md#deadness_witness:
      ...
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#deadness_witness rev1 (deadness witness requirements for exception discharge).
    glossary.md#coherence_witness:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#coherence_witness rev1 (coherence witness requirements for branching exception paths).
    glossary.md#exception_path:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#exception_path rev1 (exception path enumeration + stability).
    glossary.md#handledness_witness:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
    ...
    in/in-25.md#in_in_25:
      ...
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed in/in-25.md rev8 (coherence evidence remains orthogonal to exception obligations).
    in/in-26.md#in_in_26:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed in/in-26.md rev8 (rewrite verification predicates include exception obligations).
    out/out-3.md#out_out_3:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
