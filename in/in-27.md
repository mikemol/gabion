...
doc_review_notes:
  ...
  glossary.md: "Reviewed glossary rev29 (obsolescence projection path + self-review/mirror definitions); exception-handledness semantics unchanged."
  ...
  AGENTS.md: "Agent obligations unchanged; exception obligations remain audit-driven."
  in/in-23.md: "Uses carrier/provenance artifacts to anchor exception sites."
  in/in-24.md: "Deadness witnesses discharge exception obligations."
  in/in-25.md: "Coherence evidence remains orthogonal to exception obligations."
  in/in-26.md: "Rewrite verification predicates include exception obligations."
  out/out-3.md: "Carrier hypothesis supports exception evidence framing."
...
Normative pointers (explicit): `POLICY_SEED.md`, `glossary.md`, `CONTRIBUTING.md`, `README.md`, `AGENTS.md`, `in/in-23.md`, `in/in-24.md`, `in/in-25.md`, `in/in-26.md`, `out/out-3.md`.
