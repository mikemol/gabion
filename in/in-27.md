...
doc_review_notes:
  ...
  glossary.md#contract: Reviewed glossary.md#contract rev1 (glossary contract + semantic
    typing discipline).
  glossary.md#deadness_witness: Reviewed glossary.md#deadness_witness rev1 (deadness
    witness requirements for exception discharge).
  glossary.md#coherence_witness: Reviewed glossary.md#coherence_witness rev1 (coherence
    witness requirements for branching exception paths).
  glossary.md#exception_path: Reviewed glossary.md#exception_path rev1 (exception
    path enumeration + stability).
  glossary.md#handledness_witness: Reviewed glossary.md#handledness_witness rev1 (handledness
    witness requirements + handler boundary).
  ...
  AGENTS.md#agent_obligations: Agent obligations unchanged; exception obligations
    remain audit-driven.
  in/in-23.md#in_in_23: Reviewed in/in-23.md rev7 (deadness witness pinning added);
    no conflicts.
  in/in-24.md#in_in_24: Reviewed in/in-24.md rev8 (deadness witnesses discharge exception
    obligations).
  in/in-25.md#in_in_25: Reviewed in/in-25.md rev8 (coherence evidence remains orthogonal
    to exception obligations).
  in/in-26.md#in_in_26: Reviewed in/in-26.md rev8 (rewrite verification predicates
    include exception obligations).
  out/out-3.md#out_out_3: Carrier hypothesis supports exception evidence framing.
...
doc_section_reviews:
  in_in_27:
    ...
    glossary.md#deadness_witness:
      ...
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#deadness_witness rev1 (deadness witness requirements
        for exception discharge).
    glossary.md#coherence_witness:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#coherence_witness rev1 (coherence witness requirements
        for branching exception paths).
    glossary.md#exception_path:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#exception_path rev1 (exception path enumeration +
        stability).
    glossary.md#handledness_witness:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#handledness_witness rev1 (handledness witness requirements
        + handler boundary).
    glossary.md#exception_obligation:
      dep_version: 1
      self_version_at_review: 1
    ...
    AGENTS.md#agent_obligations:
      ...
      self_version_at_review: 1
      outcome: no_change
      note: Agent obligations unchanged; exception obligations remain audit-driven.
    in/in-23.md#in_in_23:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
    ...
    in/in-24.md#in_in_24:
      ...
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed in/in-24.md rev8 (deadness witnesses discharge exception obligations).
    in/in-25.md#in_in_25:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed in/in-25.md rev8 (coherence evidence remains orthogonal to exception
        obligations).
    in/in-26.md#in_in_26:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed in/in-26.md rev8 (rewrite verification predicates include exception
        obligations).
    out/out-3.md#out_out_3:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Carrier hypothesis supports exception evidence framing.
---
...
Implementation status update (GH-80):

* typed `except` handledness matching is now emitted with explicit reason codes (`TYPED_MATCH`, `TYPED_MISMATCH`, `TYPE_UNRESOLVED`, `BROAD_EXCEPT`) in JSON artifacts and markdown summaries;
* broad `except:` handling remains explicit evidence (`BROAD_EXCEPT`) and is not silently conflated with typed handling;
* unresolved dynamic raise paths remain `UNKNOWN` with machine-readable handledness reasons to preserve conservative soundness.

Acceptance notes (GH-80):

* fixtures now cover typed handled (`except ValueError`), typed non-handled (`except TypeError` on `ValueError` path), broad catch (`except:`), and unresolved dynamic raise (`raise e`) retaining `UNKNOWN`;
* obligation and handledness summaries include handledness reason codes to keep report output auditable and machine-consumable.

Normative pointers (explicit): [POLICY_SEED.md#policy_seed](POLICY_SEED.md#policy_seed), [glossary.md#contract](glossary.md#contract), [glossary.md#deadness_witness](glossary.md#deadness_witness), [glossary.md#coherence_witness](glossary.md#coherence_witness), [glossary.md#exception_path](glossary.md#exception_path), [glossary.md#handledness_witness](glossary.md#handledness_witness), [glossary.md#exception_obligation](glossary.md#exception_obligation), [CONTRIBUTING.md#contributing_contract](CONTRIBUTING.md#contributing_contract), [README.md#repo_contract](README.md#repo_contract), [AGENTS.md#agent_obligations](AGENTS.md#agent_obligations), [in/in-23.md#in_in_23](in/in-23.md#in_in_23), [in/in-24.md#in_in_24](in/in-24.md#in_in_24), [in/in-25.md#in_in_25](in/in-25.md#in_in_25), [in/in-26.md#in_in_26](in/in-26.md#in_in_26), [out/out-3.md#out_out_3](out/out-3.md#out_out_3).
...
* assign stable `exception_path_id` (normalized identity key from site + source kind + local signature)
