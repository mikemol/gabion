...
- Key functions (`src/gabion/analysis/legacy_dataflow_monolith.py`): `_accumulate_function_index_for_tree`, `_unused_params`, `_analyze_unused_arg_flow_indexed`.
- Representative tests (`tests/`): `tests/test_unused_arg_audit.py::test_unused_arg_reports_unknown_key_carrier_category`, `tests/test_legacy_dataflow_monolith_helpers.py::test_deserialize_param_use_filters_malformed_values`.
