...
doc_review_notes:
  ...
  glossary.md#tier: Reviewed glossary.md#tier rev1 (tier evidence thresholds + promotion
    requirements).
  glossary.md#decision_table: Reviewed glossary.md#decision_table rev1 (decision table
    tier definition).
  glossary.md#decision_bundle: Reviewed glossary.md#decision_bundle rev1 (decision
    bundle tier definition).
  glossary.md#decision_protocol: Reviewed glossary.md#decision_protocol rev1 (decision
    protocol tier definition).
  ...
  CONTRIBUTING.md#contributing_contract: Reviewed CONTRIBUTING.md rev1 (docflow now
    ...
    document's scope.
  AGENTS.md#agent_obligations: Agent obligations unchanged; decision-surface enforcement
    aligns with glossary tiers.
...
doc_section_reviews:
  in_in_15:
    ...
    AGENTS.md#agent_obligations:
      ...
      self_version_at_review: 1
      outcome: no_change
      note: Agent obligations unchanged; decision-surface enforcement aligns with
        glossary tiers.
---
...
* Refactor output shows correct `contextvar` promotion for at least one bundle
  * Evidence (GH-61 synthesis half): `tests/test_synthesis_contextvar_emission.py` snapshots cover single ambient value, grouped bundle, and advisory-only unsupported candidate.
...
Status: partial (decision-surface classification + synthesis emission shipped; callsite rewrite pending)
...
- Contextvar synthesis emission is available for ambient candidates; conservative callsite rewrite remains pending.
