...
1. **MS1 — ASPF classed subtree reuse (`src/gabion/analysis/legacy_dataflow_monolith.py`, `src/gabion/analysis/structure_reuse_classes.py`)**
...
2. **MS2 — Fingerprint/rewrite witness coupling (`src/gabion/analysis/dataflow_decision_surfaces.py`, `src/gabion/analysis/legacy_dataflow_monolith.py`)**
