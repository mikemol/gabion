...
- Key functions (`src/gabion/analysis/legacy_dataflow_monolith.py`): `_iter_dataclass_call_bundles`, `_unresolved_starred_witness` (local helper within `_iter_dataclass_call_bundles`).
- Representative tests (`tests/`): `tests/test_legacy_dataflow_monolith_edges.py::test_iter_dataclass_call_bundles_dynamic_starred_records_unresolved`, `tests/test_legacy_dataflow_monolith_edges.py::test_iter_dataclass_call_bundles`.
