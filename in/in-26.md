...
doc_review_notes:
  ...
  glossary.md#deadness_witness: Reviewed glossary.md#deadness_witness rev1 (deadness
    witness obligations for rewrite predicates).
  glossary.md#coherence_witness: Reviewed glossary.md#coherence_witness rev1 (coherence
    witness requirements for ambiguity predicates).
  glossary.md#rewrite_plan: Reviewed glossary.md#rewrite_plan rev1 (proof-carrying
    rewrite plan semantics + verification predicate).
  ...
  AGENTS.md#agent_obligations: Agent obligations unchanged; rewrite plan flow remains
    explicit.
  in/in-23.md#in_in_23: Reviewed in/in-23.md rev7 (deadness witness pinning added);
    no conflicts.
  in/in-24.md#in_in_24: Reviewed in/in-24.md rev8 (deadness evidence supplies acceptance
    predicates).
  in/in-25.md#in_in_25: Reviewed in/in-25.md rev8 (coherence evidence supplies verification
    predicates).
  out/out-3.md#out_out_3: Carrier hypothesis remains the foundation for proof-carrying
    rewrites.
  ...
  in_in_26:
    ...
    glossary.md#deadness_witness:
      ...
      note: Reviewed glossary.md#deadness_witness rev1 (deadness witness obligations
        for rewrite predicates).
    glossary.md#coherence_witness:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#coherence_witness rev1 (coherence witness requirements
        for ambiguity predicates).
    glossary.md#rewrite_plan:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#rewrite_plan rev1 (proof-carrying rewrite plan semantics
    ...
    AGENTS.md#agent_obligations:
      ...
      self_version_at_review: 1
      outcome: no_change
      note: Agent obligations unchanged; rewrite plan flow remains explicit.
    in/in-23.md#in_in_23:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
    ...
    in/in-24.md#in_in_24:
      ...
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed in/in-24.md rev8 (deadness evidence supplies acceptance predicates).
    in/in-25.md#in_in_25:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed in/in-25.md rev8 (coherence evidence supplies verification predicates).
    out/out-3.md#out_out_3:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
      note: Carrier hypothesis remains the foundation for proof-carrying rewrites.
---
...
Status: **implemented** for the three additional kinds originally scoped as planned in rev9. <!-- docflow:status-triplet-override -->
