...
doc_review_notes:
  ...
  glossary.md#ambiguity_set: Reviewed glossary.md#ambiguity_set rev2 (ambiguity sets are emergent from CallCandidate alts on call suites).
  glossary.md#partition_witness: Reviewed glossary.md#partition_witness rev2 (partition witnesses attach to call suites; ambiguity set is virtual).
...
doc_section_reviews:
  in_in_30:
    ...
    glossary.md#ambiguity_set:
      ...
      self_version_at_review: 4
      outcome: no_change
      note: Reviewed glossary.md#ambiguity_set rev2 (ambiguity sets are emergent from CallCandidate alts on call suites).
    glossary.md#partition_witness:
      dep_version: 2
      self_version_at_review: 4
      outcome: no_change
      note: Reviewed glossary.md#partition_witness rev2 (partition witnesses attach to call suites; ambiguity set is virtual).
    CONTRIBUTING.md#contributing_contract:
      dep_version: 1
      self_version_at_review: 4
      outcome: no_change
