...
doc_review_notes:
  ...
  glossary.md: "Reviewed glossary rev29 (obsolescence projection path + self-review/mirror definitions); ASPF carrier/provenance terms unchanged."
  ...
  AGENTS.md: "Agent obligations remain consistent with evidence-first carrier work."
