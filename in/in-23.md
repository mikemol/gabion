...
* `src/gabion/analysis/dataflow_audit.py::_compute_fingerprint_provenance`
* `src/gabion/analysis/dataflow_audit.py::_compute_fingerprint_synth`
* `src/gabion/analysis/type_fingerprints.py::synth_registry_payload`
...
* `tests/test_type_fingerprints.py::test_synth_registry_payload_roundtrip`
* `tests/test_fingerprint_warnings.py::test_fingerprint_provenance_emits_entries`
