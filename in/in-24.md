...
doc_review_notes:
  ...
  glossary.md#deadness_witness: Reviewed glossary.md#deadness_witness rev1 (deadness
    witness obligations + environment evidence).
  ...
  AGENTS.md#agent_obligations: Agent obligations unchanged; evidence artifacts remain
    advisory.
  in/in-23.md#in_in_23: Reviewed in/in-23.md rev7 (deadness witness pinning added);
    no conflicts.
  out/out-3.md#out_out_3: ASPF/SPPF hypothesis provides the carrier basis for negative
    evidence.
...
doc_section_reviews:
  in_in_24:
    ...
    glossary.md#deadness_witness:
      ...
      self_version_at_review: 1
      outcome: no_change
      note: Reviewed glossary.md#deadness_witness rev1 (deadness witness obligations
    ...
    AGENTS.md#agent_obligations:
      ...
      self_version_at_review: 1
      outcome: no_change
      note: Agent obligations unchanged; evidence artifacts remain advisory.
    in/in-23.md#in_in_23:
      dep_version: 1
      self_version_at_review: 1
      outcome: no_change
    ...
    out/out-3.md#out_out_3:
      ...
      self_version_at_review: 1
      outcome: no_change
      note: ASPF/SPPF hypothesis provides the carrier basis for negative evidence.
---
...
Normative pointers (explicit): [POLICY_SEED.md#policy_seed](POLICY_SEED.md#policy_seed), [glossary.md#aspf](glossary.md#aspf), [glossary.md#deadness_witness](glossary.md#deadness_witness), [CONTRIBUTING.md#contributing_contract](CONTRIBUTING.md#contributing_contract), [README.md#repo_contract](README.md#repo_contract), [AGENTS.md#agent_obligations](AGENTS.md#agent_obligations), [in/in-23.md#in_in_23](in/in-23.md#in_in_23), [out/out-3.md#out_out_3](out/out-3.md#out_out_3).
...
### 2.4 Emergent lemma (universal obligation)

Because ASPF carriers are **finite and enumerated** (`in-23` §0.2), a deadness
claim is a **universal obligation**: the counterexample projection must be
empty. Operationally, deadness witnesses are the universal-quantifier case of
the embedded intuitionistic FOL: “no counterexample exists.”
...
* every sorted field in deadness artifacts must disclose its sort key/function
  (or comparator shape) and rationale in the producer contract; non-lexical
  sorts must declare comparator components explicitly.
* each carrier consumes active sorting at most once; boundary egress must
  enforce established order without serializer `sort_keys=True` fallback for
  already-canonical carriers.
...
* each enforced sort in generation/emission code documents sort key semantics
  and rationale (lexical vs non-lexical) at the helper or enforcement site
* repeated active sorting of the same carrier is rejected as a contract
  violation
