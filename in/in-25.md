...
doc_review_notes:
  ...
  glossary.md: "Reviewed glossary rev29 (obsolescence projection path + self-review/mirror definitions); branch/coherence terminology unchanged."
  ...
  AGENTS.md: "Agent obligations unchanged; coherence evidence remains advisory."
  in/in-23.md: "Uses carrier/provenance artifacts; consistent with ASPF obligations."
  in/in-24.md: "Coherence complements deadness; no contradictions in evidence regimes."
  out/out-3.md: "ASPF/SPPF equivalence supports coherence witness framing."
...
Normative pointers (explicit): `POLICY_SEED.md`, `glossary.md`, `CONTRIBUTING.md`, `README.md`, `AGENTS.md`, `in/in-23.md`, `in/in-24.md`, `out/out-3.md`.
...
* `boundary`:
  ...
  * `basis_hash` or basis identity marker if present
