...
doc_reviewed_as_of:
  ...
  docs/projection_semantic_fragment_rfc.md#projection_semantic_fragment_rfc: 43
...
| `2026-03-11` | The outward-facing `PolicySuiteResult` payload no longer projects the runtime/wrapper `cached` bit; cache-hit state remains an in-memory wrapper concern instead of a reporting or semantic contract. | `src/gabion/tooling/runtime/policy_scanner_suite.py`; `tests/gabion/tooling/runtime_policy/test_policy_scanner_suite.py`; `tests/test_policy_dsl.py`; `docs/projection_semantic_fragment_rfc.md#projection_semantic_fragment_rfc` |
