...
- in/in-20.md — **partial** (prime registry + canonical type keys + arithmetic ops implemented; remaining fingerprint mapping/rewrite work; SPPF/GH-68.)
- in/in-21.md — **partial** (longform expansion of in-20; arithmetic ops implemented; remaining mapping/rewrite work; SPPF/GH-68.)
