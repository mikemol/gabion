...
- in/in-20.md — **partial** (prime registry + canonical type keys implemented; remaining fingerprint arithmetic; SPPF/GH-68.)
- in/in-21.md — **partial** (longform expansion of in-20; base registry implemented; remaining arithmetic/rewrite work; SPPF/GH-68.)
