...
- aspf (ASPF (Algebraic Structural Prime Fingerprint)) requires=4
...
- forest (Forest (Interned Carrier Graph)) requires=2
- handledness_witness (Handledness Witness) requires=2
- hash_consing (Hash‑Consing (Internment)) requires=3
...
- suite_site (SuiteSite) requires=2
...
- matched: True
- docflow_ambiguous_terms: 9
- projection_ambiguous_terms: 9
