...
def _capture_complexity_metrics(root: Path) -> dict[str, Any]:
    ...
    try:
        cmd = [
            ...
            "--",
            "python",
            "scripts/misc/complexity_audit.py",
            "--root",
            str(root),
            "--emit",
            str(tmp_path),
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    start.add_argument(
        ...
        default=True,
        help="Capture pre-slice complexity metrics with scripts/misc/complexity_audit.py.",
    )
    start.add_argument(
        "--pre-metrics-json",
        type=Path,
    ...
    finish.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Capture post-slice complexity metrics with scripts/misc/complexity_audit.py.",
    )
    finish.add_argument(
        "--post-metrics-json",
        type=Path,
