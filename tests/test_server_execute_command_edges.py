...
# gabion:evidence E:call_footprint::tests/test_server_execute_command_edges.py::test_execute_command_state_path_handles_non_mapping_active_summary_via_mocked_state::server.py::gabion.server.execute_command
def test_execute_command_state_path_handles_non_mapping_active_summary_via_mocked_state(
    tmp_path: Path,
    ...
    baseline = test_obsolescence_delta.ObsolescenceBaseline(
        ...
        generated_by_spec_id="mock-base",
        generated_by_spec={},
    )
    mocked_state = test_obsolescence_state.ObsolescenceState(
        candidates=[],
        baseline=baseline,
        baseline_payload={
            "version": 2,
        ...
        generated_by_spec_id="mock-state",
        generated_by_spec={},
    )
    monkeypatch.setattr(
    ...
    monkeypatch.setattr(
        command_orchestrator.test_obsolescence_state,
        "load_state",
        lambda _path: mocked_state,
    )
