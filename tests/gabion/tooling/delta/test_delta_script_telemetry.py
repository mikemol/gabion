...
from gabion.tooling.delta import delta_state_emit
from gabion.tooling.delta import delta_triplets
...
def test_delta_state_emit_main_emits_progress_telemetry_and_deduplicates(
    ...
    def _fake_run_command_direct(
        ...
        *,
        ...
        post_progress = _canonical_progress_notification(
            {
                "phase": "post",
                "work_done": 0,
                "work_total": 2,
        ...
        post_done = _canonical_progress_notification(
            {
                "phase": "post",
                "work_done": 2,
                "work_total": 2,
...
def test_delta_emit_modules_ignore_non_mapping_progress_and_dedupe_duplicates(
    ...
    def _run(_request, *, root: Path, notification_callback=None) -> dict[str, object]:
        ...
        progress = _canonical_progress_notification(
            {
                "phase": "collection",
                "event_seq": 1,
                "phase_timeline_header": "| ts | phase |",
