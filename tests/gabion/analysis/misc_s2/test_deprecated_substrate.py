...
from gabion.analysis.core.deprecated_substrate import (
    DeprecatedBlocker, DeprecatedFiber, DeprecatedLifecycleState, build_deprecated_extraction_artifacts, check_semantic_fiber_continuity, classify_branch_coverage_loss, deprecated, detect_report_section_extinction, enforce_non_erasability_policy, ingest_perf_samples, rank_fiber_groups)
