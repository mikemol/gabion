...
def test_apply_namespace_records_to_identity_space_controls_ledger_mode() -> None:
    ...
    applied_hydrated = apply_namespace_records_to_identity_space(
    ...
    applied_live = apply_namespace_records_to_identity_space(
        identity_space=space,
    ...
    assert space.allocation_records_payload() == [
        {
            "seq": 1,
            "namespace": "synth",
            "token": "tail",
