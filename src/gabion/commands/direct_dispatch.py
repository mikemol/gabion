...
_UNORDERED_DIRECT_EXECUTORS: dict[str, DirectExecutor] = {
    command_ids.CHECK_COMMAND: server.execute_command,
    command_ids.DATAFLOW_COMMAND: server.execute_command,
    command_ids.STRUCTURE_DIFF_COMMAND: server.execute_structure_diff,
    command_ids.STRUCTURE_REUSE_COMMAND: server.execute_structure_reuse,
    command_ids.DECISION_DIFF_COMMAND: server.execute_decision_diff,
