...
from gabion.analysis.aspf_core import parse_2cell_witness
...
from gabion.analysis.evidence import Site, exception_obligation_summary_for_site
...
def _compute_fingerprint_synth(
    ...
    *,
    ...
    if existing is not None:
        ...
        from gabion.analysis.type_fingerprints import build_synth_registry
