...
from .marker_metadata import (
    keyword_links_literal as _keyword_links_literal,
    keyword_string_literal as _keyword_string_literal,
    marker_alias_kind_map,
    marker_kind_for_call,
    never_marker_metadata,
    never_reason as _never_reason,
)
...
def never_reason(
    ...
    *,
    ...
    return _never_reason(call, check_deadline_fn=check_deadline_fn)
