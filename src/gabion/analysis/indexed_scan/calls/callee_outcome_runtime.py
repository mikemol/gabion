...
def resolve_callee_outcome_from_runtime_module(
    callee_key: str,
    caller: object,
    by_name: dict[str, list[object]],
    by_qual: dict[str, object],
    *,
    ...
    return resolve_callee_outcome(
        ...
        deps=CalleeOutcomeDeps(
            ...
            callee_resolution_context_core_ctor=runtime_module._CalleeResolutionContextCore,
            resolve_callee_with_effects_fn=runtime_module._resolve_callee_with_effects_impl,
            collect_callee_resolution_effects_fn=(
                runtime_module._collect_callee_resolution_effects_impl
            ),
            module_name_fn=runtime_module._module_name,
            dedupe_resolution_candidates_fn=runtime_module._dedupe_resolution_candidates,
            callee_key_fn=runtime_module._callee_key,
            is_dynamic_dispatch_callee_key_fn=runtime_module._is_dynamic_dispatch_callee_key,
            outcome_ctor=runtime_module._CalleeResolutionOutcome,
            default_resolve_callee_fn=runtime_module._resolve_callee,
        ),
    )
