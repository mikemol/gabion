...
def collect_constant_flow_details_from_runtime_module(
    paths: list[Path],
    *,
    project_root,
    ignore_params: set[str],
    ...
    return collect_constant_flow_details(
        paths,
        project_root=project_root,
        ...
        deps=CollectConstantFlowDetailsDeps(
            ...
            require_not_none_fn=runtime_module.require_not_none,
            resolved_edge_reducer_spec_ctor=runtime_module._ResolvedEdgeReducerSpec,
            constant_flow_fold_accumulator_ctor=runtime_module._ConstantFlowFoldAccumulator,
            format_call_site_fn=runtime_module._format_call_site,
            function_key_fn=runtime_module._function_key,
            sort_once_fn=runtime_module.sort_once,
            constant_flow_detail_ctor=runtime_module.ConstantFlowDetail,
        ),
    )
