...
def populate_bundle_forest_from_runtime_module(
    forest: object,
    *,
    groups_by_path: dict[Path, dict[str, list[set[str]]]],
    file_paths: list[Path],
    ...
    populate_bundle_forest(
        ...
        deps=BundleForestBuildDeps(
            ...
            iter_monotonic_paths_fn=runtime_module._iter_monotonic_paths,
            build_analysis_index_fn=runtime_module._build_analysis_index,
            sort_once_fn=runtime_module.sort_once,
            is_test_path_fn=runtime_module._is_test_path,
            materialize_structured_suite_sites_fn=(
                runtime_module._materialize_structured_suite_sites
            ),
            add_interned_alt_fn=runtime_module._add_interned_alt,
            collect_config_bundles_fn=runtime_module._collect_config_bundles,
            collect_dataclass_registry_fn=runtime_module._collect_dataclass_registry,
            build_symbol_table_fn=runtime_module._build_symbol_table,
            iter_documented_bundles_fn=runtime_module._iter_documented_bundles,
            iter_dataclass_call_bundles_fn=runtime_module._iter_dataclass_call_bundles,
