...
def accumulate_function_index_for_tree_from_runtime_module(
    acc: object,
    path: Path,
    tree: ast.Module,
    *,
    ...
    accumulate_function_index_for_tree(
        ...
        deps=FunctionIndexAccumulatorDeps(
            ...
            parent_annotator_ctor=runtime_module.ParentAnnotator,
            module_name_fn=runtime_module._module_name,
            collect_lambda_function_infos_fn=runtime_module._collect_lambda_function_infos,
            collect_lambda_bindings_by_caller_fn=runtime_module._collect_lambda_bindings_by_caller,
            direct_lambda_callee_by_call_span_fn=runtime_module._direct_lambda_callee_by_call_span,
            ...
            analyze_function_fn=runtime_module._analyze_function,
            is_test_path_fn=runtime_module._is_test_path,
            materialize_direct_lambda_callees_fn=runtime_module._materialize_direct_lambda_callees,
            unused_params_fn=runtime_module._unused_params,
            decision_surface_reason_map_fn=runtime_module._decision_surface_reason_map,
            value_encoded_decision_params_fn=runtime_module._value_encoded_decision_params,
            param_names_fn=runtime_module._param_names,
            param_annotations_fn=runtime_module._param_annotations,
            param_defaults_fn=runtime_module._param_defaults,
            decorators_transparent_fn=runtime_module._decorators_transparent,
            param_spans_fn=runtime_module._param_spans,
            node_span_fn=runtime_module._node_span,
            function_info_ctor=runtime_module.FunctionInfo,
        ),
    )
