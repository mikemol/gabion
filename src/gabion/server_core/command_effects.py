...
class CommandEffects(Protocol):
    ...
    load_analysis_resume_checkpoint_manifest_fn: Callable[..., object]
    write_analysis_resume_checkpoint_fn: Callable[..., None]
    load_analysis_resume_checkpoint_fn: Callable[..., object]
    ...
    load_report_phase_checkpoint_fn: Callable[..., object]
