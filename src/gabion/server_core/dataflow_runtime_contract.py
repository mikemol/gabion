...
# Progress
PROGRESS_DEFAULT_PHASE_TIMELINE_MD = DEFAULT_PHASE_TIMELINE_MD
PROGRESS_DEFAULT_PHASE_TIMELINE_JSONL = DEFAULT_PHASE_TIMELINE_JSONL
PROGRESS_COLLECTION_CHECKPOINT_FLUSH_INTERVAL_NS = COLLECTION_CHECKPOINT_FLUSH_INTERVAL_NS
PROGRESS_COLLECTION_CHECKPOINT_MEANINGFUL_MIN_INTERVAL_NS = COLLECTION_CHECKPOINT_MEANINGFUL_MIN_INTERVAL_NS
PROGRESS_COLLECTION_REPORT_FLUSH_INTERVAL_NS = COLLECTION_REPORT_FLUSH_INTERVAL_NS
PROGRESS_COLLECTION_REPORT_FLUSH_COMPLETED_STRIDE = COLLECTION_REPORT_FLUSH_COMPLETED_STRIDE
PROGRESS_DEFAULT_HEARTBEAT_SECONDS = DEFAULT_PROGRESS_HEARTBEAT_SECONDS
PROGRESS_MIN_HEARTBEAT_SECONDS = MIN_PROGRESS_HEARTBEAT_SECONDS
PROGRESS_DEADLINE_FLUSH_SECONDS_DEFAULT = PROGRESS_DEADLINE_FLUSH_SECONDS
PROGRESS_DEADLINE_WATCHDOG_SECONDS_DEFAULT = PROGRESS_DEADLINE_WATCHDOG_SECONDS
PROGRESS_HEARTBEAT_POLL_SECONDS_DEFAULT = PROGRESS_HEARTBEAT_POLL_SECONDS
PROGRESS_DEADLINE_FLUSH_MARGIN_SECONDS_DEFAULT = PROGRESS_DEADLINE_FLUSH_MARGIN_SECONDS
PROGRESS_LSP_NOTIFICATION_METHOD = LSP_PROGRESS_NOTIFICATION_METHOD
PROGRESS_LSP_TOKEN_V2 = LSP_PROGRESS_TOKEN_V2
PROGRESS_PHASE_PRIMARY_UNITS = PHASE_PRIMARY_UNITS
PROGRESS_HEARTBEAT_SECONDS = progress_heartbeat_seconds

# Ingress
INGRESS_IS_STDOUT_TARGET = is_stdout_target
INGRESS_STDOUT_ALIAS = STDOUT_ALIAS
INGRESS_STDOUT_PATH = STDOUT_PATH

# Timeout
TIMEOUT_DEADLINE_TICK_BUDGET_ALLOWS_CHECK = deadline_tick_budget_allows_check

# Report serialization
REPORT_DEFAULT_SECTION_JOURNAL = DEFAULT_REPORT_SECTION_JOURNAL
REPORT_COLLECTION_CHECKPOINT_FLUSH_DUE = collection_checkpoint_flush_due
REPORT_COLLECTION_REPORT_FLUSH_DUE = collection_report_flush_due
REPORT_PROJECTION_PHASE_FLUSH_DUE = projection_phase_flush_due
