...
def _packet_enforce_command(options: LocalCiReproOptions) -> tuple[str, ...]:
    args = [
        str(options.python_bin),
...
def _delta_bundle_command(options: LocalCiReproOptions) -> tuple[str, ...]:
    inner = [
        str(options.python_bin),
        "-m",
        "gabion",
...
def _checks_steps(options: LocalCiReproOptions) -> tuple[LocalCiReproStep, ...]:
    ...
    steps = [
        ...
        LocalCiReproStep(
            ...
            command=_packet_enforce_command(options),
            mode="checks",
        ),
        LocalCiReproStep(
        ...
        LocalCiReproStep(
            ...
            command=_delta_bundle_command(options),
            timed=True,
            mode="checks",
        ),
        LocalCiReproStep(
