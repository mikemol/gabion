            ...
            _touchpoint_definition(
                ...
                declared_touchsites=(
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="aspf-facade",
                        rel_path="src/gabion/analysis/aspf/aspf.py",
                        qualname="__all__",
                        boundary_name="ASPF semantic facade public surface",
                        line=22,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="aspf-owner",
                        rel_path="src/gabion/analysis/foundation/aspf_impl.py",
                        qualname="canonicalize_evidence",
                        boundary_name="ASPF semantic owner public alias surface",
                        line=232,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="aspf-execution-fibration-facade",
                        rel_path="src/gabion/analysis/aspf/aspf_execution_fibration.py",
                        qualname="__all__",
                        boundary_name="ASPF execution-fibration facade public surface",
                        line=40,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="aspf-execution-fibration-owner",
                        rel_path="src/gabion/analysis/foundation/aspf_execution_fibration_impl.py",
                        qualname="ImportedTraceMergeVisitor",
                        boundary_name="ASPF execution-fibration owner public alias surface",
                        line=1515,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="aspf-resume-state-facade",
                        rel_path="src/gabion/analysis/aspf/aspf_resume_state.py",
                        qualname="__all__",
                        boundary_name="ASPF resume-state facade public surface",
                        line=21,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="aspf-resume-state-owner",
                        rel_path="src/gabion/analysis/foundation/aspf_resume_state_impl.py",
                        qualname="__all__",
                        boundary_name="ASPF resume-state owner public export surface",
                        line=252,
                    ),
                ),
            ),
