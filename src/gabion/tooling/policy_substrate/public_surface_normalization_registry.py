...
@todo_decorator(
    reason="PSN-TP-006 remains in progress until dataflow/reporting helper clusters stop importing underscore-prefixed foreign symbols and instead depend on explicit public owner contracts.",
    reasoning={
        ...
        touchpoints=(
            ...
            _touchpoint_definition(
                ...
                declared_touchsites=(
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="dataflow-evidence-helpers-owner",
                        rel_path="src/gabion/analysis/dataflow/engine/dataflow_evidence_helpers.py",
                        qualname="__all__",
                        boundary_name="dataflow evidence-helper owner public export surface",
                        line=675,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="dataflow-analysis-index",
                        rel_path="src/gabion/analysis/dataflow/engine/dataflow_analysis_index.py",
                        qualname="_accumulate_symbol_table_for_tree",
                        boundary_name="dataflow analysis-index evidence helper consumer surface",
                        line=360,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="dataflow-projection-materialization",
                        rel_path="src/gabion/analysis/dataflow/engine/dataflow_projection_materialization.py",
                        qualname="_collect_call_ambiguities_indexed",
                        boundary_name="dataflow projection-materialization evidence helper consumer surface",
                        line=412,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="dataflow-deadline-runtime",
                        rel_path="src/gabion/analysis/dataflow/engine/dataflow_deadline_runtime.py",
                        qualname="_COLLECT_DEADLINE_LOCAL_INFO_DEPS",
                        boundary_name="dataflow deadline-runtime evidence helper consumer surface",
                        line=216,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="dataflow-bundle-iteration",
                        rel_path="src/gabion/analysis/dataflow/engine/dataflow_bundle_iteration.py",
                        qualname="iter_dataclass_call_bundle_effects",
                        boundary_name="dataflow bundle-iteration evidence helper consumer surface",
                        line=439,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="dataflow-lambda-runtime-support",
                        rel_path="src/gabion/analysis/dataflow/engine/dataflow_lambda_runtime_support.py",
                        qualname="_collect_closure_lambda_factories",
                        boundary_name="dataflow lambda-runtime evidence helper consumer surface",
                        line=80,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="dataflow-obligations",
                        rel_path="src/gabion/analysis/dataflow/engine/dataflow_obligations.py",
                        qualname="_append_origin_obligations",
                        boundary_name="dataflow obligations evidence helper consumer surface",
                        line=182,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="dataflow-refactor-planning",
                        rel_path="src/gabion/analysis/dataflow/io/dataflow_refactor_planning.py",
                        qualname="build_refactor_plan",
                        boundary_name="dataflow refactor-planning evidence helper consumer surface",
                        line=45,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="dataflow-synthesis",
                        rel_path="src/gabion/analysis/dataflow/io/dataflow_synthesis.py",
                        qualname="_build_synthesis_plan",
                        boundary_name="dataflow synthesis evidence helper consumer surface",
                        line=308,
                    ),
                ),
            ),
