        ...
        touchpoints=(
            ...
            _touchpoint_definition(
                ...
                declared_touchsites=(
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="dataflow-bundle-merge-owner",
                        rel_path="src/gabion/analysis/dataflow/engine/dataflow_bundle_merge.py",
                        qualname="__all__",
                        boundary_name="dataflow bundle-merge owner public export surface",
                        line=42,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="dataflow-lint-helpers",
                        rel_path="src/gabion/analysis/dataflow/engine/dataflow_lint_helpers.py",
                        qualname="merge_counts_by_knobs",
                        boundary_name="dataflow lint-helpers bundle-merge consumer surface",
                        line=833,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        ...
                        qualname="render_synthesis",
                        boundary_name="dataflow synthesis bundle-merge consumer surface",
                        line=164,
                    ),
                ),
            ),
