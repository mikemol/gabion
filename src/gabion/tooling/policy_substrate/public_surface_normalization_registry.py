        ...
        touchpoints=(
            ...
            _touchpoint_definition(
                ...
                declared_touchsites=(
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="dataflow-parse-helpers-owner",
                        rel_path="src/gabion/analysis/dataflow/io/dataflow_parse_helpers.py",
                        qualname="__all__",
                        boundary_name="dataflow parse-helper owner public export surface",
                        line=114,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="dataflow-reporting-helpers",
                        rel_path="src/gabion/analysis/dataflow/io/dataflow_reporting_helpers.py",
                        qualname="_report_lines_by_section",
                        boundary_name="dataflow reporting helper import surface",
                        line=20,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        ...
                        qualname="_ModuleArtifactSpec",
                        boundary_name="dataflow analysis-index stage helper surface",
                        line=157,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="dataflow-post-phase-analyses",
                        rel_path="src/gabion/analysis/dataflow/engine/dataflow_post_phase_analyses.py",
                        qualname="_StageCacheSpec",
                        boundary_name="dataflow post-phase parse-stage cache surface",
                        line=1213,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        ...
                        qualname="_COLLECT_CALL_NODES_BY_PATH_DEPS",
                        boundary_name="dataflow deadline runtime parse-stage dependency surface",
                        line=240,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        ...
                        boundary_name="dataflow bundle-iteration parse helper consumer surface",
                        line=439,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="dataflow-function-index-helpers",
                        rel_path="src/gabion/analysis/dataflow/engine/dataflow_function_index_helpers.py",
                        qualname="_build_function_index",
                        boundary_name="dataflow function-index parse helper consumer surface",
                        line=643,
                    ),
                    _touchsite(
                        touchpoint_id="PSN-TP-006",
                        slug="dataflow-evidence-helpers",
                        rel_path="src/gabion/analysis/dataflow/engine/dataflow_evidence_helpers.py",
                        qualname="_build_symbol_table",
                        boundary_name="dataflow evidence helper parse consumer surface",
                        line=496,
                    ),
                ),
            ),
