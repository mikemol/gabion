...
@todo_decorator(
    ...
    reasoning={
        "summary": "Control-loop artifacts are still emitted and consumed as adjacent sidecars rather than one connected graph of governance evidence, failure bundles, planner outputs, and remediation state.",
