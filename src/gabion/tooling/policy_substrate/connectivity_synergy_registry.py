            ...
            _touchpoint_definition(
                ...
                declared_touchsites=(
                    _function_touchsite(
                        ...
                        qualname="build_ci_checks_steps",
                        line=115,
                        surface="control_loop_artifact",
                        structural_path="checks_runtime::build_ci_checks_steps",
                    ),
                    _static_touchsite(
                        touchsite_id="CSA-RGC-TS-074",
                        rel_path="src/gabion/cli_support/tooling_commands.py",
                        qualname="tooling_commands#checks",
                        line=113,
                        node_kind="call",
                        surface="control_loop_artifact",
                        structural_path="tooling_commands::checks",
                    ),
                    _static_touchsite(
