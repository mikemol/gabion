            ...
            children=stream_from_factory(
                ...
                (
                    ...
                    bullet_list(
                        ...
                        key="workstreams",
                        children=stream_from_factory(_workstream_items),
                    ),
                    section(
                        identity=ArtifactSourceRef(
                            rel_path="<synthetic>",
            ...
            children=stream_from_factory(
                ...
                (
                    ...
                    bullet_list(
                        ...
                        key="ledgers",
                        children=stream_from_factory(_ledger_items),
                    ),
                    section(
                        identity=ArtifactSourceRef(
                            rel_path="<synthetic>",
...
class InvariantLedgerDeltaProjections:
            ...
            children=stream_from_factory(
                ...
                (
                    ...
                    bullet_list(
                        ...
                        key="deltas",
                        children=stream_from_factory(_delta_items),
                    ),
                    section(
                        identity=ArtifactSourceRef(
                            rel_path="<synthetic>",
    ...
    def markdown_document(self) -> ArtifactUnit:
        ...
        return document(
            ...
            children=stream_from_factory(_doc_sections),
        )
            ...
            children=stream_from_factory(
                ...
                (
                    ...
                    bullet_list(
                        ...
                        key="alignments",
                        children=stream_from_factory(_alignment_items),
                    ),
                    section(
                        identity=ArtifactSourceRef(
                            rel_path="<synthetic>",
...
def build_invariant_ledger_projections(
    ...
    *,
    ...
    return InvariantLedgerProjections(
        ...
        ledgers=stream_from_factory(_ledger_items),
    )
...
def build_invariant_ledger_delta_projections(
    *,
    ...
    return InvariantLedgerDeltaProjections(
        ...
        deltas=stream_from_factory(lambda: iter(deltas)),
    )
...
def build_invariant_ledger_alignments(
    *,
    ...
    return InvariantLedgerAlignments(
        root=str(root),
        generated_at_utc=datetime.now(timezone.utc).isoformat(),
        alignments=stream_from_factory(_alignment_items),
    )
    ...
    *,
    ...
    def _touchpoint_projection(
        *,
        ...
        return InvariantTouchpointProjection(
            ...
            touchsites=stream_from_factory(_iter_touchsites),
    ...
    def _workstream_projection(root_object_id: str) -> InvariantWorkstreamProjection:
        ...
        workstream = InvariantWorkstreamProjection(
            ...
            subqueues=stream_from_factory(_iter_subqueues),
            touchpoints=stream_from_factory(_iter_touchpoints),
    ...
    return InvariantWorkstreamsProjection(
        ...
        workstreams=stream_from_factory(
            lambda: (
