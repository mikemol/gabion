...
- **Repo next action:** `diagnostic_backlog` via `investigate_diagnostic_backlog` on `WS-SEED:artifacts.out`
...
| --- | --- | --- | ---: | --- |
| `CSA-RGC` | Declarative registry convergence and wrapper/package inversion cleanup | `in_progress` | 209 | `CSA-RGC-TP-002` |
| `CSA-IDR` | Identity/rendering separation and structural interning rollout | `in_progress` | 87 | `CSA-IDR-TP-003` |
| `CSA-IGM` | Ingress/merge witness, remap, and non-Python ASPF adapter rollout | `in_progress` | 83 | `CSA-IGM-TP-002` |
