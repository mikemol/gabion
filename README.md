...
- **Repo next action:** `workspace_preservation` via `stage_validate_commit_graph_participating_change` on `CSA-RGC`
...
| --- | --- | --- | ---: | --- |
| `CSA-RGC` | Declarative registry convergence and wrapper/package inversion cleanup | `in_progress` | 305 | `CSA-RGC-TP-002` |
| `CSA-IGM` | Ingress/merge witness, remap, and non-Python ASPF adapter rollout | `in_progress` | 179 | `CSA-IGM-TP-002` |
